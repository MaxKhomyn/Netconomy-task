...
export const MOCK_COLUMNS_ONLY_ID = {
  id: { isVisible: true, name: 'ID' },
  name: { isVisible: false, name: 'Name' },
  department: { isVisible: false, name: 'Department' },
  price: { isVisible: false, name: 'Price' },
  currency: { isVisible: false, name: 'Currency' },
};
